        ...
        <main class="flex-shrink-0 bg-light bg-opacity-75 main-content">
            <?php 
                if (isset($_GET['search']) && !empty($_GET['search'])) { 
                    ...
                    $search = $_GET['search'];
                    $datas = $classInventory->getProductsBySearchPerPage($search, $page_no, $total_records_per_page, $offset, $previous_page, $next_page, $adjacents);
                    $infos = $classInventory->getProductsBySearch($search);
                    $datacount = $infos;
                ...
                <div class="container mb-4">
                    <div class="border-bottom-custom-green mb-4 mt-1">
                        <div class="card-header text-center fw-bold text-uppercase d-flex align-items-center justify-content-start pb-2 text-custom-green">
                            <i class="fa-solid fa-magnifying-glass fa-fw fs-4 me-2"></i>Search for: <?php echo $search ?? ""; ?> <?php if (!empty($datas)) { ?> (<?php echo $datacount ?? ""; ?>) <?php } ?>
                        </div>
                    </div>
                    ...
                    <?php foreach ($datas as $data) { ?>
                            ...
                            <a href="index.php?route=product&pid=<?php echo $data['productUniqueId']; ?>&pd=<?php echo $data['model']; ?>" class="text-decoration-none text-dark">
                                <div class="card shadow bg-success bg-opacity-50 card-product h-100">
                                    ...
                                    <div class="card-body bg-light bg-opacity-25" style="height: 8rem;">
                                        <p class="card-title" style="font-size: 0.6rem;">Product Name:ad <?php echo $data['productDesc'] ?? ""; ?></p>
                        ...
                        <?php } else {?>  
                            <div class="d-flex justify-content-center w-100">
                                <p class="fs-4">No result/s found for <strong>"<?php echo $search ?? "";; ?>"</strong>.</p>
                            </div>
                        <?php } ?> 
                    ...
                    <?php if (!empty($datas) && $datacount > 24) { ?>
                        <div class="d-flex justify-content-center mt-4">
                            <ul class="pagination">
                                ...
                                <?php if ($page_no > 1) { ?>
                                    <li class="page-item">
                                        <a class="page-link" href="index.php?route=search&search=<?php echo $search; ?>&page_no=1">First</a>
                                    </li>
                                <?php } ?>
                                ...
                                <?php } else { ?>         
                                    <li class="page-item">
                                        <a class="page-link" href="index.php?route=search&search=<?php echo $search; ?>&page_no=<?php echo $previous_page ?>">Previous</a>
                                    </li>
                                <?php } ?>  
                                    ...
                                    <?php for ($counter = 1; $counter <= $total_no_of_pages; $counter++) { ?>
                                        <?php if ($counter == $page_no) { ?>
                                            <li class="page-item active" aria-current="page">
                                                <a class="page-link" href="index.php?route=search&search=<?php echo $search; ?>&page_no=<?php echo $counter; ?>"><?php echo $counter; ?></a>
                                            </li>
                                        <?php } else { ?>
                                            <li class="page-item">
                                                <a class="page-link" href="index.php?route=search&search=<?php echo $search; ?>&page_no=<?php echo $counter; ?>"><?php echo $counter; ?></a>
                                ...
                                <?php } elseif ($total_no_of_pages > 10) { ?>  
                                    <?php if ($page_no <= 4) { ?>
                                        ...
                                        <?php } ?>
                                            ...
                                            <li class="page-item">
                                                <a class="page-link" href="index.php?route=search&search=<?php echo $search; ?>&page_no=<?php echo $second_last; ?>"><?php echo $second_last; ?></a>
                                            </li>
                                            <li class="page-item">
                                                <a class="page-link" href="index.php?route=search&search=<?php echo $search; ?>&page_no=<?php echo $total_no_of_pages; ?>"><?php echo $total_no_of_pages; ?></a>
                                            </li>
                                    <?php } elseif ($page_no > 4 && $page_no < $total_no_of_pages - 4) { ?>
                                        <li class="page-item">
                                            <a class="page-link" href="index.php?route=search&search=<?php echo $search; ?>&page_no=1">1</a>
                                        </li>
                                        <li class="page-item">
                                            <a class="page-link" href="index.php?route=search&search=<?php echo $search; ?>&page_no=2">2</a>
                                        </li>
                                        <li class="page-item">
                                            <a class="page-link">...</a>
                                        </li>
                                        ...
                                        <li class="page-item">
                                            <a class="page-link" href="index.php?route=search&search=<?php echo $search; ?>&page_no=<?php echo $second_last; ?>"><?php echo $counter; ?></a>
                                        </li>
                                        <li class="page-item">
                                            <a class="page-link" href="index.php?route=search&search=<?php echo $search; ?>&page_no=<?php echo $total_no_of_pages; ?>"><?php echo $counter; ?></a>
                                        </li>
                                    <?php } else { ?>
                                        <li class="page-item">
                                            <a class="page-link" href="index.php?route=search&search=<?php echo $search; ?>&page_no=1">1</a>
                                ...
                                <?php } else {  ?>
                                    <?php if($page_no < $total_no_of_pages) { ?>
                                        <li class="page-item">
                                            <a class="page-link" href="index.php?route=search&search=<?php echo $search; ?>&page_no=<?php echo $next_page ?>">Next</a>
                                        </li>
                                    <?php } ?>
                                <?php } ?>
                                ...
                                <?php if ($page_no < $total_no_of_pages) { ?>
                                    <li class="page-item">
                                        <a class="page-link" href="index.php?route=search&search=<?php echo $search; ?>&page_no=<?php echo $total_no_of_pages ?>">Last</a>
                                    </li>
                                <?php } ?>
                            </ul>
                        </div>
            ...
            <?php } else { 
                echo "<script>
                    swal('Warning!', 'Invalid search!', 'warning').then(function() {
