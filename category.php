...
<head>
    ...
    <title>Category: <?php echo $_GET['cn']; ?></title>
</head>
<body class="d-flex flex-column h-100">
    <?php 
        ...
        if (isset($_GET['cid']) && !empty($_GET['cid'])){
            ...
            $categoryUniqueId = $_GET['cid'];
            $datas = $classInventory->getProductsByCatPerPage($categoryUniqueId, $page_no, $total_records_per_page, $offset, $previous_page, $next_page, $adjacents);
            $infos = $classInventory->getProductsByCat($categoryUniqueId);
            $datacount = $infos;
            ...
            <div class="container mb-4">
                <div class="border-bottom-custom-green mb-4 mt-1">
                    <div class="card-header text-center fw-bold text-uppercase d-flex align-items-center justify-content-start pb-2 text-custom-green">
                        <i class="fa-solid fa-table-list fa-fw fs-4 me-2"></i>Category: <?php echo $categoryName ?? ""; ?>
                    </div>
                </div>
                ...
                <?php if (!empty($datas) && $datacount > 24) { ?>
                    <div class="d-flex justify-content-center mt-4">
                        <ul class="pagination">
                            ...
                            <?php if ($page_no > 1) { ?>
                                <li class="page-item">
                                    <a class="page-link" href="index.php?route=category&cid=<?php echo $cid ?? ""; ?>&page_no=1">First</a>
                                </li>
                            <?php } ?>
                            ...
                            <?php } else { ?>         
                                <li class="page-item">
                                    <a class="page-link" href="index.php?route=category&cid=<?php echo $cid ?? ""; ?>&page_no=<?php echo $previous_page ?>">Previous</a>
                                </li>
                            <?php } ?>  
                                ...
                                <?php for ($counter = 1; $counter <= $total_no_of_pages; $counter++) { ?>
                                    <?php if ($counter == $page_no) { ?>
                                        <li class="page-item active" aria-current="page">
                                            <a class="page-link" href="index.php?route=category&cid=<?php echo $cid ?? ""; ?>&page_no=<?php echo $counter; ?>"><?php echo $counter; ?></a>
                                        </li>
                                    <?php } else { ?>
                                        <li class="page-item">
                                            <a class="page-link" href="index.php?route=category&cid=<?php echo $cid ?? ""; ?>&page_no=<?php echo $counter; ?>"><?php echo $counter; ?></a>
                            ...
                            <?php } elseif ($total_no_of_pages > 10) { ?>  
                                <?php if ($page_no <= 4) { ?>
                                    ...
                                    <?php } ?>
                                        ...
                                        <li class="page-item">
                                            <a class="page-link" href="index.php?route=category&cid=<?php echo $cid ?? ""; ?>&page_no=<?php echo $second_last; ?>"><?php echo $second_last; ?></a>
                                        </li>
                                        <li class="page-item">
                                            <a class="page-link" href="index.php?route=category&cid=<?php echo $cid ?? ""; ?>&page_no=<?php echo $total_no_of_pages; ?>"><?php echo $total_no_of_pages; ?></a>
                                        </li>
                                <?php } elseif ($page_no > 4 && $page_no < $total_no_of_pages - 4) { ?>
                                    <li class="page-item">
                                        <a class="page-link" href="index.php?route=category&cid=<?php echo $cid ?? ""; ?>&page_no=1">1</a>
                                    </li>
                                    <li class="page-item">
                                        <a class="page-link" href="index.php?route=category&cid=<?php echo $cid ?? ""; ?>&page_no=2">2</a>
                                    </li>
                                    <li class="page-item">
                                        <a class="page-link">...</a>
                                    </li>
                                    ...
                                    <li class="page-item">
                                        <a class="page-link" href="index.php?route=category&cid=<?php echo $cid ?? ""; ?>&page_no=<?php echo $second_last; ?>"><?php echo $counter; ?></a>
                                    </li>
                                    <li class="page-item">
                                        <a class="page-link" href="index.php?route=category&cid=<?php echo $cid ?? ""; ?>&page_no=<?php echo $total_no_of_pages; ?>"><?php echo $counter; ?></a>
                                    </li>
                                <?php } else { ?>
                                    <li class="page-item">
                                        <a class="page-link" href="index.php?route=category&cid=<?php echo $cid ?? ""; ?>&page_no=1">1</a>
                            ...
                            <?php } else {  ?>
                                <?php if($page_no < $total_no_of_pages) { ?>
                                    <li class="page-item">
                                        <a class="page-link" href="index.php?route=category&cid=<?php echo $cid ?? ""; ?>&page_no=<?php echo $next_page ?>">Next</a>
                                    </li>
                                <?php } ?>
                            <?php } ?>
                            ...
                            <?php if ($page_no < $total_no_of_pages) { ?>
                                <li class="page-item">
                                    <a class="page-link" href="index.php?route=category&cid=<?php echo $cid ?? ""; ?>&page_no=<?php echo $total_no_of_pages ?>">Last</a>
                                </li>
                            <?php } ?>
                        </ul>
                    </div>
